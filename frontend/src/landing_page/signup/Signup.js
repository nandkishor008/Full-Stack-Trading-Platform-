...
function Signup() {
  return (
    <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '80vh', background: '#f8fafc' }}>
      <div className="card shadow" style={{ width: 380, border: 'none', borderRadius: 16, padding: 32, background: '#fff' }}>
        <h2 className="mb-4 text-center" style={{ color: '#387ed1', fontWeight: 700 }}>Create your Zerodha account</h2>
        ...
        <form action="http://localhost:3002/signup" method="POST">
          ...
          <button type="submit" className="btn btn-primary w-100" style={{ borderRadius: 8, background: '#387ed1', border: 'none', fontWeight: 600 }}>
            Sign Up
          </button>
        </form>

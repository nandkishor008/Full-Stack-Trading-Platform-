    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-3">
          <h4 className=" ">
            <i class="fa-solid fa-circle-plus"></i>&nbsp;Acount Opening
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-3">
          <h4 className=" ">
            <i class="fa-solid fa-user-gear"></i>&nbsp;Your Zerodha Account
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-3">
          <h4 className=" ">
            <i class="fa-regular fa-paper-plane"></i>&nbsp;Kite
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-3">
          <h4 className=" ">
            <i class="fa-regular fa-chart-bar"></i>&nbsp;Console
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-3">
          ...
          <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>CGovernment Securities</a>
        </div>
      </div>
    </div>
  );
